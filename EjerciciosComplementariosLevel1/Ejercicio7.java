...
public class Complementario7 {
  private static char minus[] = {' ','a','b','c','d','e','f','g','h','i','j','k','l','m','n','ñ','o','p','q','r','s','t','u','v','w','x','y','z'};
  private static char mayus[] = {' ','A','B','C','D','E','F','G','H','I','J','K','L','M','N','Ñ','O','P','Q','R','S','T','U','V','W','X','Y','Z'};
  ...
  public static void main(String[] args) {		
    ...
    for(int i = 0; i < longitud; i = i +1 ){
      ...
      for(int j = 0; j < 27; j = j +1 ){
        if(minus[j]==valor || mayus[j]==valor){ 
          if (aux==null){
